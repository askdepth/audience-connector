...
// │ it sends a request with NO signature and NO timestamp header, and it    │
// │ PASSES only when the connector REFUSES to answer — a 401 in the         │
// │ documented error envelope. A 2xx, any other status, or a 401 in the     │
...
// must be rejected identically. Probing more than one guards against a
// connector that only gates the data endpoints.
